...
-- Tiempo de generación: 26-08-2024 a las 14:11:05
...
--
-- Estructura de tabla para la tabla `fsc_cities`
--

DROP TABLE IF EXISTS `fsc_cities`;
CREATE TABLE IF NOT EXISTS `fsc_cities` (
...
--
-- Volcado de datos para la tabla `fsc_cities`
--

INSERT INTO `fsc_cities` (`city_id`, `country_id`, `city`) VALUES
(2, 1, 'Villa Gesell'),
(3, 2, 'Miami Beach'),
(4, 2, 'California');
...
--
-- Estructura de tabla para la tabla `fsc_documents`
--

DROP TABLE IF EXISTS `fsc_documents`;
CREATE TABLE IF NOT EXISTS `fsc_documents` (
  `document_id` int NOT NULL AUTO_INCREMENT,
  `document_name` varchar(80) NOT NULL,
  `document_file` text NOT NULL,
  `document_short_description` text NOT NULL,
  `document_country_id` int NOT NULL,
  `document_city_id` int NOT NULL,
