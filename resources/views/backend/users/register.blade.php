    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="page-title col-md-6">
                ...
                <h4 class="section-title">Users <span class="total-section-title-content">Create a new user</span></h4>
                    ...
                    <div class="card-block">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 ml-auto mr-auto">
                                ...
                                <form method="post" action="{{ route('register-user') }}" id="user-registration-form">
                                        @csrf
